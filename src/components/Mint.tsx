      ...
      <MintContainer>
        {!wallet ? (
          ...
          <MintCard data-aos="flip-left">
              ...
              <MintButton 
              style={{color: "#2d2d2d", backgroundColor:"white",border: "2px solid #2d2d2d", transition: "all 200ms ease-in-out",borderRadius : "30px", margin: "4rem 0 0 0",padding: "0.5rem 2rem"}}
